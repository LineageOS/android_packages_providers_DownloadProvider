...
public final class DownloadProvider extends ContentProvider {
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        if (checkCallingUidBanned()) {
            ...
            return ContentUris.withAppendedId(Downloads.Impl.CONTENT_URI, 0);
        }
    ...
    private boolean checkCallingUidBanned() {
        ...
        if (networkPolicy.getUidPolicy(uid) & (POLICY_REJECT_ON_DATA | POLICY_REJECT_ON_WLAN) ==
                (POLICY_REJECT_ON_DATA | POLICY_REJECT_ON_WLAN)) {
