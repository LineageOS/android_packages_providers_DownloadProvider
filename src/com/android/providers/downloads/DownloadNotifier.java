...
public class DownloadNotifier {
    ...
    private void updateWithLocked(Cursor cursor) {
        ...
        for (int i = 0; i < clustered.size(); i++) {
            ...
            // display the current number of files being downloaded correctly.
            int numPaused = 0;
            ...
            if (cluster.size() == 1) {
                ...
                if (type == TYPE_ACTIVE) {
                    ...
                    if (speedAsSizeText != null) {
                        String notifSpeedText = res.getString(R.string.text_download_speed,
                                remainingText, speedAsSizeText);
                        builder.setContentText(notifSpeedText);
                        inboxStyle.setSummaryText(notifSpeedText);
                    } else {
                        builder.setContentText(remainingText);
