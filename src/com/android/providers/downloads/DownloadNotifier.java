...
public class DownloadNotifier {
    ...
    private static final int SPEED_kbit = 1000;
    private static final int SPEED_Mbit = 1000000;
    private static final int SPEED_Gbit = 1000000000;
    ...
    private static final String SPEED_PLACEHOLDER = "%s %cbit/s";
            ...
            if (type == TYPE_ACTIVE) {
                ...
                if (total > 0) {
                    ...
                    if (speed > 0) {
                        ...
                        if (speed < SPEED_kbit) {
                            preFix = '\0';
                        } else if (speed < SPEED_Mbit) {
                            preFix = 'k';
                            speedNormalized /= SPEED_kbit;
                        } else if (speed < SPEED_Gbit) {
                            preFix = 'M';
                            speedNormalized /= SPEED_Mbit;
                        } else {
                            preFix = 'G';
                            speedNormalized /= SPEED_Gbit;
                        }
